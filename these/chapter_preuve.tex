...
\begin{tabular}{p{5cm} p{.5cm} p{9cm} p{2cm}}
  ...
  \comp{\lstinline'/*@ assert P; */ A'}{$env$}
  &=& \comp{A}{$env$} si \eval{P}{$env$} & \eqlabel{C-assert-OK} \\
  ...
  & = & \comp{\lstinline'/*@ loop invariant I; loop assigns X; loop variant v; */ while(e) A'}{\comp{A}{$env$}} sinon
  & \eqlabel{C-loop} \\
  \\
