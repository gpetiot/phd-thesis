...
les annotations est détaillée en partie~\ref{sec:grammar}, leur sémantique est
...
\begin{figure}[tb]
  \begin{tabular}{lrl}
    ...
    & $\mid$ & \textit{lval} \underline{\lstinline'='} \textit{exp}
    \underline{\semicolon} \\
    & $\mid$ & \textit{id} \underline{\lstinline'('} \textit{exp}$^{*}$
    \underline{\lstinline');'} \\
    & $\mid$ & \textit{lval} \underline{\lstinline'='} \textit{id}
    ...
    \underline{\lstinline'\; */'} \\
    & $\mid$ & \underline{\lstinline'/*@ loop invariant'} \textit{pred}
    \underline{\semicolon} \\
    ...
    \underline{\lstinline'\; */'} \\
                      &     & \textit{type} \textit{id}
    \underline{\lstinline'('} (\textit{type} \textit{lvalue})$^{*}$
    \underline{\lstinline')'} \underline{$\bopen$} \textit{block}
    \underline{$\bclose$} \\
  \end{tabular}
