...
La première règle énonce qu'une séquence vide ne modifie pas l'environnement.
La deuxième règle évalue l'instruction $i$ au label $l$ afin de calculer le
nouvel environnement.
La troisième règle traite le cas de la concaténation d'insertions de code.
