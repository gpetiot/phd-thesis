...
\begin{definition}[Masque du plus grand préfixe commun (MPGPC)]
  Le MPGPC de $a$ et $b$ est le plus grand masque $\le$ à la négation du
  {\em ou}-exclusif de $a$ et de $b$.
\end{definition}
...
$nxor$.
La variable $nxor$ contient la négation du {\em ou}-exclusif de $a$ et $b$.
