...
Nous donnerons plus de détails sur le \textit{store} en
partie~\ref{sec:mem-model}.
...
La fonction \lstinline'__delete_block' permet d'enlever un bloc du
\textit{store}.
...
d'un bloc à un autre en cas de \lstinline'realloc'.
