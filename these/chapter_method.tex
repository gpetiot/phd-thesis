...
\begin{figure*}[bt]\centering
  \begin{tabular}{c|c|l|c|c|c|c}
    ...
    is \NCCE \\ \hline
    % example/rgf_2.c
    2 & 34 & \lstinline'loop assigns i,a[1..n-1];'
    ...
    &&&&&&
    $\mathbf{nondet}_{\textbf{\mbox{\lstinline'a[1]'}}} \textbf{\mbox{\lstinline'=97157'}}\mbox{\lstinline';'}$ \\
    ...
    & 22 & \lstinline'requires n>0 && n<21;' &&&& \\ \hline
    % example/rgf_4.c
