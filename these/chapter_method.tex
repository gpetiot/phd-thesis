...
Les deux premiers cas présentent une non-conformité du code vis-à-vis de
...
L'étape \NCD génère un \NCCE (cas \circled{1}, \#1 sur la
...
pour ce même contrat (cas \circled{2}, \#2 sur la
...
(non classifié) (cas \circled{4}, \#4 sur la figure~\ref{tab:versions-rgf}).
