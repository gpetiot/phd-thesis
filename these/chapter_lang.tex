...
%Les règles \eqlabel{P-forall} et \eqlabel{P-exists} sont définies de manière
%similaire aux règles \eqlabel{E-sum}, \eqlabel{E-prod} et \eqlabel{E-num}.
Dans la règle \eqlabel{P-forall} nous définissons une fonction $P'(v_1,v_2,f)$
pour tous $v_1$ et $v_2$ de type $VAL$ et pour toute fonction
$f : VAL \rightarrow VAL$.
...
deux premiers paramètres ($t_1$ et $t_2$) sont évalués avant le troisième.
