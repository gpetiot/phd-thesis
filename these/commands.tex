...
\newcommand{\eval}[2]{$\mathscr{E}$ $\llbracket$ #1 $\rrbracket$ #2}
\newcommand{\comp}[2]{$\mathscr{C}$ $\llbracket$ #1 $\rrbracket$ #2} 
...
\newcommand{\openpar}{{\color{blue}\textbf{(}}}
\newcommand{\closepar}[1]{{\color{blue}\textbf{)$_{#1}$}}}
