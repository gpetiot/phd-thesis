...
% Alain : je propose les trois paragraphes suivants pour remplacer ceci :
% \textit{``Dans ce chapitre, nous présentons la notion de non-conformité entre le
% code et sa spécification, puis nous illustrons la détection de non-conformités
...
Alice écrit d'abord la précondition suivante (ajoutée avant la ligne 1 de la
figure~\ref{fig:deleteSubstrTrous}) :
