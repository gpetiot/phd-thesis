...
\subsubsection{\textsc{PolySpace}}

\subsubsection{\textsc{Astree}}

\subsubsection{\textsc{Fluctuat}}

\subsubsection{\textsc{Value}}
...
\subsubsection{\textsc{Coq}}

\subsubsection{\textsc{Isabelle}}

\subsubsection{\textsc{WP}}
...
\subsubsection{Résumé de boucle}

\cite{loop-summarization}
...
\textsc{Yogi} \cite{YOGI}, \textsc{Magic} \cite{MAGIC} et \textsc{Slam}
\cite{SLAM}.


\subsection{\textsc{DSD-Crasher}}
...
statique de programmes C : \textsc{Stanse} \cite{STANSE}, dont l'intérêt réside
dans le fait qu'il n'y aurait aucun autre framework open-source ayant une
efficacité et une applicabilité comparable. Ils ne sont donc pas au courant de
l'existence de \textsc{Frama-C} \cite{Frama-C}.
...
Conctrairement à \textsc{Sante} \cite{SANTE} qui commence par utiliser une
