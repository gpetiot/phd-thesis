...
int is_present(int* t, int n, int v) {
 ...
 §$l_0:$§
  ...
  §$\underline{\Zinit \mbox{var\_7 = n}}$§; §$\underline{\Zinit \mbox{var\_8 = i}}$§; §$\underline{\Zinit \mbox{var\_9 = var\_7}\Zclear\ \mbox{- var\_8}\Zclear}$§; int var_10 = §$\underline{ \mbox{0 <= var\_9}\Zclear}$§; fassert(var_10);
  while(i < n) {
   §$BegIter_{l_0}:$§
    §$\underline{\Zinit \mbox{var\_{11} = n}}$§; §$\underline{\Zinit \mbox{var\_{12} = i}}$§; §$\underline{\Zinit \mbox{var\_{13} = var\_{11}}\Zclear\ \mbox{- var\_{12}}\Zclear}$§; §$\underline{\Zinit \mbox{old\_variant = var\_{13}}\Zclear}$§;
   ...
   §$EndIter_{l_0}:$§
    ...
    §$\underline{\Zinit \mbox{var\_{21} = n}}$§; §$\underline{\Zinit \mbox{var\_{22} = i}}$§; §$\underline{\Zinit \mbox{var\_{23} = var\_{21}}\Zclear\ \mbox{- var\_{22}}\Zclear}$§; int var_24 = §$\underline{ \mbox{0 <= var\_{23}}\Zclear}$§; int var_25 = var_24;
    if(var_25) { §$\underline{\Zinit \mbox{var\_{26} = n}}$§; §$\underline{\Zinit \mbox{var\_{27} = i}}$§; §$\underline{\Zinit \mbox{var\_{28} = var\_{26}}\Zclear\ \mbox{- var\_{27}}\Zclear}$§; int var_29 = §$\underline{ \mbox{var\_{28}}\Zclear\ \mbox{< old\_variant}\Zclear}$§; var_25 = var_29; }
    fassert(var_25);
  }
