  ...
  \scriptsize{
    ...
    {\myinference[$\tau$-unop$_2$]
      {(l, \mbox{\lstinline't'}:\mathbb{Z}) \rulearrow (I, \mbox{\lstinline'e'})
        \quad
        unop \in \{ -, \sim\}}
      {(l, (\mbox{\lstinline'unop t'}):\mathbb{Z}) \rulearrow
        (I
    ...
    {\myinference[$\tau$-binop$_1$]
      {(l, \mbox{\lstinline't1'}:ptr) \rulearrow (I_1, \mbox{\lstinline'e1'})
        ...
        \quad
        binop \in \{+, -\}}
      {(l, (\mbox{\lstinline't1 binop t2'}):ptr) \rulearrow
        (I_1 \concat I_2
    ...
    {\myinference[$\tau$-binop$_2$]
      {(l, \mbox{\lstinline't1'}:\mathbb{Z}) \rulearrow
        ...
        binop \in \{\mathtt{+}, \mathtt{-}, \mathtt{/}, \mathtt{\%},
        \mathtt{*} \}}
      {(l, (\mbox{\lstinline't1 binop t2'}):\mathbb{Z}) \rulearrow
