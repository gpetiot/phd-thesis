...
\scriptsize{
  ...
  {\myinference[$\alpha$-check-assigns]
    ...
    {(End_f, \mathtt{assigns\ X;})
      ...
      I \concat
      \forall (x:ctype) \not \in X:
      (Beg_f, \mathtt{ctype\ assigns_x = e;})
      \concat (End_f, \mathtt{fassert(e == assigns_x);})
    }
  }
  {\myinference[$\alpha$-assume-assigns]
    ...
    {(End_f, \mathtt{assigns\ x;})
      \rulearrow
      I \concat (End_f, \mathtt{e = nondet();})}
  }
  \vspace{-1mm}
...
\begin{figure*}[tb]
  ...
  {\myinference[$\alpha$-check-loop-assigns]
    {(l, x) \rulearrow (I, e)}
    {
      \splitfrac
      {
        (l, \mathtt{loop\ assigns\ X;}) \rulearrow
      }
      {
        I \concat
        \forall (x:ctype) \not \in X:
        (BegIter_l, \mathtt{ctype\ assigns_x = e;})
        \concat (EndIter_l, \mathtt{fassert(e == assigns_x);})
      }
    }
  }
  {\myinference[$\alpha$-assume-loop-assigns]
    {(l, x) \rulearrow (I, e)}
    {(l, \mathtt{loop\ assigns\ x;})
      \rulearrow
      I \concat (l, \mathtt{e = nondet();})}
  }
  \vspace{-1mm}
 ...
 {\myinference[$\alpha$-assume-invariant-1]
    ...
    {
      (l, \mathtt{loop\ invariant\ p;}) \rulearrow
      I \concat (l, \mathtt{fassume(e\ \&\&\ !loopcond);})
    }
  }
 {\myinference[$\alpha$-assume-invariant-2]
    ...
    {
      (l, \mathtt{loop\ invariant\ p;}) \rulearrow
      I_1 \concat (l, \mathtt{fassume(e1);})
      \concat I_2 \concat (EndIter_l, \mathtt{fassert(e2);})
    }
  }
 \vspace{-1mm}

  {\myinference[$\alpha$-check-variant]
    {
