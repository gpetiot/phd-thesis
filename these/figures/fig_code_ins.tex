...
EndIter_L:
  ...
  \begin{tikzpicture}[remember picture,overlay,font=\scriptsize]
    ...
    \node[left of=l-ins1,node distance=2.5cm] (l1) {\texttt{L},};
    \node[ins,draw=red,below of=l-ins1] (l-ins2) {
      \lstinline[basicstyle=\tiny\ttfamily]
                {mpz_t v2; __gmpz_init_set_si(v2,y);}};
    \node[left of=l-ins2,node distance=2.5cm] (l2) {\texttt{L},};
    ...
    \node[left of=l-ins3a,node distance=2.5cm] (l3) {\texttt{L},};
    \node[ins,draw=gray,below of=l-ins3] (l-ins4) {
      \lstinline[basicstyle=\tiny\ttfamily]
                {mpz_t v4; __gmpz_init_set_si(v4,x);}};
    \node[left of=l-ins4,node distance=3.15cm] (l5) {\texttt{EndIter\_L},};
    \node[ins,draw=gray,below of=l-ins4] (l-ins5) {
      \lstinline[basicstyle=\tiny\ttfamily]
                {mpz_t v5; __gmpz_init_set_si(v5,y);}};
    \node[left of=l-ins5,node distance=3.15cm] (l6) {\texttt{EndIter\_L},};
    ...
    \node[left of=l-ins6a,node distance=3.15cm] (l7) {\texttt{EndIter\_L},};
    \node[ins,draw=orange,below of=l-ins6] (l-ins7) {
      \lstinline[basicstyle=\tiny\ttfamily]{assert(v3);}};
    \node[left of=l-ins7,node distance=2.5cm] (l4) {\texttt{L},};
    \node[ins,draw=gray,below of=l-ins7] (l-ins8) {
      \lstinline[basicstyle=\tiny\ttfamily]{assert(v6);}};
    \node[left of=l-ins8,node distance=3.15cm] (l8) {\texttt{EndIter\_L},};
    %% arrow for order
