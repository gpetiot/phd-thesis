...
le fragment $c_i$ sera inséré dans le programme traduit au label $l_i$ :
...
dans une séquence d'insertions de code globale, qui est unique pour toutes les
fonctions.
...
résultat d'une fonction, \lstinline{\valid} est un prédicat (leur grammaire est
