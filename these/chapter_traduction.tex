...
%% Chaque couple $(l_i, c_i)$ de la séquence d'insertions globale donne lieu à
%% l'insertion du fragment $c_i$ au label $l_i$ dans le programme traduit.
%% Quand plusieurs fragments ont le même label (et doivent donc être insérés au
%% même endroit), ils sont insérés dans le programme traduit en respectant leur
%% ordre dans la séquence (l'ordre dans lequel ils ont été générés).
