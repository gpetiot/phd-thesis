...
\textit{\underline{not\_while\_stmt}} est toute instruction du C qui n'est pas
une boucle.
...
lignes 28--32 du listing~\ref{lst:abbrv}, elle définit que \lstinline|\result|
est non nul si et seulement si il existe un élément de \lstinline|t| égal à
\lstinline|v|.
...
aux lignes 29--31 du listing~\ref{lst:abbrv} et la variable fraîche contenant la
