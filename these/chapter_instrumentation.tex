...
$I_v$, $I_a$, définies sur la figure~\ref{fig:P} \textbf{(b)}, où $\arule$ est
...
Ces règles utilisent la traduction des prédicats notée $(l, p) \prule (I, e)$ et
la traduction des termes notée $(l, t) \trule (I, e)$.
...
\subsection{Correction de la traduction des assertions}
...
\subsection{Correction de la traduction des contrats de boucles}
...
\subsection{Correction de la traduction des contrats de fonctions}
