...
utilisées dans le listing~\ref{lst:Z:1}.
La notation abrégée est utilisée dans la suite du document.
Cette notation nous permet de réécrire
...
\begin{figure}\centering
  \begin{tabular}{c|c|c}
    ...
    & \lstinline'Z_clear(x);' \\
  \end{tabular}
  \caption{Notations pour l'arithmétiques non bornée \label{fig:Z-not}}
\end{figure}
