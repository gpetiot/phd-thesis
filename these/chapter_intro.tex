...
La \emph{vérification} \cite{glossaire} est la confirmation par l'examen et la
fourniture de preuves objectives que des exigences d'un système (correction,
cohérence, précision, etc.) spécifiées ont été remplies.
La \emph{validation} est la confirmation par l'examen et la fourniture de
preuves objectives que les exigences d'un système spécifiées ont été remplies,
\textit{pour un usage ou une application voulue}.
